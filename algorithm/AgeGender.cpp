...
//            continue;
    ...
    vector<string> babiesAgeList = {"(0-2)", "(4-6)", "(8-12)"};
    size_t babiesCounter = 0;
...
//            cout << "Gender: " << gender << endl;
        ...
        */
        ...
        cout << "Age: " << age << endl;
        if (find(babiesAgeList.begin(), babiesAgeList.end(), age) != babiesAgeList.end())
        {
            babiesCounter++;
        }
...
//        }
    ...
    if (babiesCounter == bboxes.size())
    {
        cout << "still babies in the car\n"; //TODO
        string string1 = "python3 send_msg.py";
